#Bu projede priorityleri %50 yaklaştırmaya calisyorum
import random
import queue
...
text_file3=open("deneme3.txt","w")
text_file4=open("deneme4.txt","w")
        ...
        if(len(self.unit)==0 and Queue1.show()>0 and Queue2.display()>0):
            ...
            if(Queue1.adet!=0):
                ...
                print("Q1 Oranı:"+str(Queue1oran))
                                    #Try to close %0.50
                if(Queue1oran>0.50):#decrease the Q1 prob
                    fark=Queue1oran-Queue2oran
                    degisim=fark/2
                    self.Queue1prob=self.Queue1prob-degisim
                    print("degisim :"+str(degisim))
                elif(Queue1oran<0.50):
                    fark=Queue2oran-Queue1oran
                    degisim=fark/2
                    self.Queue1prob=self.Queue1prob+degisim
                    print("degisim:"+str(degisim))
